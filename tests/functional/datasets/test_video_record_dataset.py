...
from torchvideo.datasets import VideoRecordDataset
from torchvideo.datasets import RecordSet
...
class TestVideoRecordDataset:
    ...
    def test_using_custom_frame_counter(self, video_folder_dir):
        ...
        def frame_counter(path): return const_length
